...
public class admininterface {
	 ...
	 */
	public admininterface(String nume) {
		initialize(nume);
	}
	...
	private void initialize(String nume) {
		...
		tabbedPane.addTab("Detalii admin", null, panel_8, null);
	...
	try {
        ...
        String query = "call showInfoAdmin('"+ nume + "')";
		Statement sta = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
	...
	String[] tableHead9 = {"idstudent", "parola", "cnp","nume","prenume","adresa","telefon","email"};
